...
This fork is from [Twitter/typeahead.js](). The aim is to provide bug fixes and necessary missing features in that version.  Hopefully the next version of typeahead.js will render this fork obsolete.   
...
* [@ryanpitts](https://github.com/ryanpitts) for the nameKey implementation 
